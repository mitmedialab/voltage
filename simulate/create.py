...
SHOT_NOISE_SCALE_MIN = 1.0e3
SHOT_NOISE_SCALE_MAX = 2.0e3
SENSOR_READ_NOISE_MIN = 0.01
SENSOR_READ_NOISE_MAX = 0.02
BACKGROUND_INTENSITY_MIN = 0.1
BACKGROUND_INTENSITY_MAX = 0.2

MISFOCUS_RATE = 0.01  # how often it happens
MISFOCUS_MAX = 10.0   # max spatial gaussian filter sigma
